...
function pintarRespuestaCategoria(items){
    ...
    for(i = 0; i < items.length; i++){   
      myTable+="<tr>";
       ...
       myTable+="<td><button class='btn btn-danger m-2' onclick='borrarInformacionCategoria("+items[i].id+")'>Borrar</button><button class='btn btn-success' onclick='modificarInformacionCategoria("+items[i].id+")'>Modificar</button></td>";
