...
function pintarRespuestaCliente(items){
   ...
   for(i=0;i<items.length;i++){
       ...
       myTable+="<td><button class='btn btn-danger' onclick='borrarInformacionCliente("+items[i].id+")'>Borrar</button>";
       myTable+="<td><button class='btn btn-success' onclick='ModificarInformacionCliente("+items[i].id+")'>Modificar</button>";
       myTable+="</tr>";
   }
